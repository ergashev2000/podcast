...
const NewPodcastsCard = () => {
  return (
    <>
      <Link to={"/detail/1"}>
        <div className="group h-fit w-full max-w-[400px] relative hover:bg-[#1A1A1A] rounded-2xl hover:scale-105 cursor-pointer p-2 transition-all duration-500 border  hover:border-gray-400 border-[#4a4a4a]">
          <div className="relative ">
            ...
            />
            <button className="group-hover:opacity-100 opacity-0 hover:bg-opacity-90 transition-all duration-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-125 bg-black bg-opacity-50 flex justify-center items-center w-10 h-10 rounded-full">
              <PlayIcon />
            </button>
          </div>
          <img
